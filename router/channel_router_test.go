...
func TestChannelUsageSummaryUsesReadPermission(t *testing.T) {
	assertChannelRoutePermission(t, http.MethodGet, "/:id/usage-summary", authz.ChannelRead, controller.GetChannelUsageSummary)
}
