...
func registerChannelRoutes(apiRouter *gin.RouterGroup) {
	...
	channelRoute.Use(middleware.ManagedAdminAuth())
...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/:id/errors", permission: authz.ChannelRead, handler: controller.GetChannelErrors},
	...
	{method: http.MethodPut, path: "/:id/error-display", permission: authz.ChannelWrite, handler: controller.UpdateChannelErrorDisplay},
	{method: http.MethodPut, path: "/:id/errors/:error_id/display", permission: authz.ChannelWrite, handler: controller.UpdateChannelErrorRecordDisplay},
