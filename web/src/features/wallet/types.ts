...
export interface TopupInfo {
  ...
  /** Whether manual WeChat payment is currently available */
  enable_manual_wechat_topup?: boolean
  /** Manual WeChat payment display name */
  manual_wechat_display_name?: string
  /** Configured QR code expiry time */
  manual_wechat_expires_at?: number
}
