...
describe('manual WeChat availability', () => {
  test('uses manual WeChat when it is the only configured top-up method', () => {
    const topupInfo = {
      enable_online_topup: false,
      enable_stripe_topup: false,
      enable_manual_wechat_topup: true,
    ...
    expect(getDefaultPaymentType(topupInfo)).toBe(PAYMENT_TYPES.MANUAL_WECHAT)
