...
export const STATIC_I18N_KEYS = [
  // Manual WeChat payment keys passed to t() through form validation or status values.
  'payment.manualWechat.settings.unsupportedFile',
  'payment.manualWechat.settings.fileTooLarge',
  'payment.manualWechat.settings.imageRequired',
  'payment.manualWechat.settings.expiryInPast',
  'payment.manualWechat.settings.instructionsTooLong',
  'admin.manualPayments.status.pending',
  'admin.manualPayments.status.success',
  'admin.manualPayments.status.expired',
