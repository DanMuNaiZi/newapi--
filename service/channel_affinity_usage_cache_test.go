...
var channelAffinityUsageCacheTestCounter atomic.Uint64
...
func newChannelAffinityStatsContextForTest(t *testing.T) (*gin.Context, string, string, string) {
	t.Helper()
	seq := channelAffinityUsageCacheTestCounter.Add(1)
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ctx, ruleName, usingGroup, keyFP := newChannelAffinityStatsContextForTest(t)
