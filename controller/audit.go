...
var auditContentTemplates = map[string]string{
	...
	"github_registration.whitelist_create": "Added GitHub registration age exemption for ${github_login} (${github_id})",
	"github_registration.whitelist_update": "Updated GitHub registration age exemption ${github_id}",
	"github_registration.whitelist_delete": "Deleted GitHub registration age exemption for ${github_login} (${github_id})",
