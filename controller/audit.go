...
var auditContentTemplates = map[string]string{
	...
	"manual_payment.topup_complete":        "Confirmed manual WeChat top-up ${trade_no} for user ${target_user_id}",
	"manual_payment.topup_expire":          "Expired manual WeChat top-up ${trade_no} for user ${target_user_id}",
	"manual_payment.subscription_complete": "Confirmed manual WeChat subscription ${trade_no} for user ${target_user_id}",
	"manual_payment.subscription_expire":   "Expired manual WeChat subscription ${trade_no} for user ${target_user_id}",
}
