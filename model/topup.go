...
type TopUp struct {
	...
	PaymentProvider string  `json:"payment_provider" gorm:"type:varchar(50);default:'';index:idx_topups_provider_status_created,priority:1"`
	CreateTime      int64   `json:"create_time" gorm:"index:idx_topups_provider_status_created,priority:3"`
	CompleteTime    int64   `json:"complete_time"`
	Status          string  `json:"status" gorm:"index:idx_topups_provider_status_created,priority:2"`
}
...
const (
	...
	PaymentProviderManualWechat = "manual_wechat"
)
...
func ManualCompleteTopUp(tradeNo string, callerIp string) error {
	return completeTopUpManually(tradeNo, callerIp, "")
}

func CompleteManualWechatTopUp(tradeNo string, callerIp string) error {
	return completeTopUpManually(tradeNo, callerIp, PaymentProviderManualWechat)
}

func completeTopUpManually(tradeNo string, callerIp string, expectedPaymentProvider string) error {
	if tradeNo == "" {
