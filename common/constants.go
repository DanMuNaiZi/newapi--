...
var GitHubRegistrationMinAgeDays = 180
...
const (
	RoleGuestUser       = 0
	RoleCommonUser      = 1
	RoleAuthorizedAdmin = 5
	RoleAdminUser       = 10
	RoleRootUser        = 100
)

func IsValidateRole(role int) bool {
	return role == RoleGuestUser || role == RoleCommonUser || role == RoleAuthorizedAdmin || role == RoleAdminUser || role == RoleRootUser
}
